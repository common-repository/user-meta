...
<div class="wrap">
    ...
    <div id="dashboard-widgets-wrap">
		<div class="metabox-holder">
			<div id="um_admin_content" class="um_form_table_list">
                <?php
...
<script>
jQuery('#um_admin_sidebar .card-collapse').removeClass('in');
jQuery('#um_admin_sidebar .card-collapse').first().addClass('in');
</script>
